 ...
 */
const AMOSTRA = [
  // Diagramas: todas as classes com texto do componente único de nó.
  '.diagram-kicker',
  '.diagram-header b',
  '.diagram-legend span',
  '.diagram-zone__title',
  ...
  '.diagram-step b',
  '.diagram-step small',
  '.diagram-control__label',
  '.diagram-control b',
  '.diagram-control small',
  '.diagram-band__items b',
  '.diagram-band__items small',
  '.diagram-node__list b',
  '.diagram-node__list small',
  '.diagram-node__subtitle',
  '.diagram-node__subflows li',
  '.diagram-node__foot',
  '.diagram-call__num',
  '.diagram-call b',
  '.diagram-call small',
